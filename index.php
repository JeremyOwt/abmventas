...
$mesActual = date("n"); // Mes actual sin cero inicial (1-12)
$anioActual = date("Y"); // Año actual (ej: 2025)

$facturacionMensual = $venta->obtenerFacturacionMensual($mesActual, $anioActual);
$facturacionAnual = $venta->obtenerFacturacionAnual($anioActual);
...
?>
    ...
    $ <?php echo number_format($facturacionMensual, 2, ",", "."); ?>
</div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
    $ <?php echo number_format($facturacionAnual, 2, ",", "."); ?>
</div>
                    </div>
                    <div class="col-auto">
