          ...
          <h1 class="h3 mb-4 text-gray-800">Venta</h1>
            ...
            <div class="row">
                ...
                <div class="col-6 form-group">
                    ...
                    <select required="" class="form-control" data-live-search="true" name="lstCliente" id="lstCliente">
                ...
                <div class="col-6 form-group">
                    ...
                    <select required="" class="form-control" data-live-search="true" name="lstProducto" id="lstProducto" onchange="fBuscarPrecio();">
                        <option value="" disabled selected>Seleccionar</option>
